...
import { FETCHING_REPO, FETCH_REPO_ERROR, FETCH_REPO_SUCCESS } from '../../actions/repo'

const middlewares = [thunkMiddleware]
const mockStore = configureMockStore(middlewares)

describe('Actions: repo actions', () => {
  test('getRepo dispatches a FETCHING_REPO action and a FETCH_REPO_SUCCESS action if it is successful', () => {
    const data = {
      type: 'commit',
      data: [{
        node: {
