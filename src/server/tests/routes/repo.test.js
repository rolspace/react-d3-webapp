...
describe('repo module', () => {
  let res, loggerStubError, loggerStubInfo

  beforeEach(() => {
    loggerStubInfo = sinon.stub(logger, 'info').callsFake(() => { })
    loggerStubError = sinon.stub(logger, 'error').callsFake(() => { })
